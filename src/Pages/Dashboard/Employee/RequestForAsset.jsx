...
//     try {
//       const { data } = await axiosCommon.put(`/request-asset/${assetId}`, requestInfo);
...
//                           {/* click the action button then open a modal */}
//                           <button
//                             onClick={() => {
//                               setOpenModal(true);
...
//                               }`}
//                             >
//                               <form onSubmit={handleRequest} className="px-5 pb-5 pt-3 lg:pb-10 lg:pt-5 lg:px-10">
